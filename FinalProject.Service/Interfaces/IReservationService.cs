...
public interface IReservationService
{
    ...
    Task<Reservation> CancelPatientReservationAsync(int patientId, int doctorId, TimeSpan reservationDate);
    Task<string> DeleteReservationAsync(Reservation reservation);

    Task<string> MakeReservationAsync(int patientId, int doctorId, TimeSpan reservationDate);
