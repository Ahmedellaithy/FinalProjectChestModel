...
public class AddDoctorByAdminValidator : AbstractValidator<AddDoctorByAdminCommand>
{
    public AddDoctorByAdminValidator()
    {
        AddDoctorByAdminValidation();
    }
    
    public void AddDoctorByAdminValidation()
    {
